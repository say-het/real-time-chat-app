        ...
        <div className="w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0">
            ...
            <form>
                ...
                <label className="label p-2">
                 ...
                 <input type="text" className="w-full input input-bordered h-10"  placeholder="Enter Full Name"/>
                <label className="label p-2">
                ...
                <input type="text" className="w-full input input-bordered h-10"  placeholder="Enter Confirm Password"/>
                  <GenderCheckBox/>
                <a href="" className="text-sm hover:underline mt-2 inline-block hover:text-blue-600">Already Have an Account?</a>
                  <div>
                    <button type="button" className="btn btn-primary w-full btn-sm mt-2">Signup</button>
                  </div>
            </form>
              </div>
        </div>
